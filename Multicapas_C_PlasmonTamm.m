...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% PARAMETROS DE INTERES PARA COMPARAR ESTE CODIGO CON EL DE FDFD
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
lambdai=400e-9;
lambdaf=800e-9;
Npl=1000;            %Numero de valores de longitud de onda tomados en este rango (si Npl=1 solo se toma lambdai).
...
lambda0=615*0.9702e-9;                %longitud de onda de referencia (en metros) que se utiliza para calcular espesores de capas.
...
rugosidad_c=0;        %Si rugosidad_c es igual a 1 sortea varias configuraciones posibles a los espesores de las capas y calcula un valor medio de la relfectancia medida.
...
if Npt==1
    figure(10)
    plot(lambda*1e9,R*100, 'DisplayName','Ajuste')
    hold on
